...
//Modelo de datos
//
//En esta variable están todos los quizzes existentes.
...
//
//Al arrancar la aplicacion, el array contiene estas cuatro preguntas
//pero al final del modulo se llama a load() para cargar las preguntas guardadas
 ...
 *
 * Se carga el contenido del fichero DB_FILENAME en la variable
 ...
 * existe, y se producirá el error ENOENT. En este caso se salva el contenido
 * inicial almacenado en quizzes.
 * Si se produce otro tipo de erro, se lanza una excepción que abortará
 ...
 *
 * Guarda en formato JSON el valor de los quizzes en el fichero DB_FILENAME.
...
//Funciones para manejar el modelo de datos.
...
/**
 * Actualiza el quiz situado en la posicion index indicada.
 *
 ...
 *
 * Devueve un clon del valor guardado en la variable quizzes, es decir devuelve un
 ...
 *
 * Para clonar quiz se usa stringify + parse.
 *
